...
from .models import ForumTopic, ForumReply, ForumNotification


@admin.register(ForumTopic)
class ForumTopicAdmin(admin.ModelAdmin):
    list_display = ('title', 'author', 'course', 'created_at', 'like_count')
...
class ForumNotificationAdmin(admin.ModelAdmin):
    ...
    search_fields = ('recipient__username', 'actor__username', 'topic__title', 'reply__content')
