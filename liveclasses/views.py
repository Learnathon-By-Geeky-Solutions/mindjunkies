...
class LiveClassListView(LoginRequiredMixin, ListView):
    model = LiveClass
    template_name = "liveclasses/list_live_classes.html"
...
class CreateLiveClassView(LoginRequiredMixin, CreateView):
    model = LiveClass
    template_name = "liveclasses/create_live_class.html"
...
class JoinLiveClassView(LoginRequiredMixin, View):
    ...
    def get(self, request, meeting_id):
        ...
        return render(request, "liveclasses/join_live_class.html", {"live_class": live_class})
