...
def run():
    categories = {
        "Computer Science": {
            ...
            "subcategories": [
                ...
                {
                    "name": "Data Science",
                    "description": "Big Data, Analytics, and Statistics",
                },
            ],
        },
        "Mathematics": {
            ...
            "subcategories": [
                ...
                {
                    "name": "Discrete Math",
                    "description": "Logic, Graph Theory, and Combinatorics",
                },
            ],
        },
        "Engineering": {
        ...
        "Business": {
            ...
            "subcategories": [
                {
                    "name": "Finance",
                    "description": "Investing, Accounting, and Risk Management",
                },
                {
                    "name": "Marketing",
                    "description": "Branding, Digital Marketing, and Sales",
                },
                {
                    "name": "Management",
                    "description": "Leadership, Strategy, and Operations",
                },
            ],
        },
        "Art & Design": {
            ...
            "subcategories": [
                {
                    "name": "Graphic Design",
                    "description": "UI/UX, Branding, and Motion Graphics",
                },
                {
                    "name": "Music",
                    "description": "Composition, Instruments, and Production",
                },
                {
                    "name": "Photography",
                    "description": "Editing, Portraits, and Landscapes",
                },
            ],
        },
    }
    ...
    for category_name, category_data in categories.items():
        ...
        for subcategory_data in category_data["subcategories"]:
            ...
            if sub_created:
                print(
                    f"  ✅ Added subcategory: {subcategory.name} under {category.name}"
                )
            else:
